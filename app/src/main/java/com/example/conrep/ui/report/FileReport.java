...
public class FileReport extends BaseActivity {
    ...
    private void addReport() {
        ...
        ChangeStatus cs = new ChangeStatus(getApplication(), new OnAsyncEventListener() {
        ...
        UpdateHours uh = new UpdateHours(getApplication(), new OnAsyncEventListener() {
            @Override
            public void onSuccess() {
        ...
        intent.putExtra("siteID", siteID);// todo 0 has to be replaced with whatever ID will be generated by the DB //partially done
