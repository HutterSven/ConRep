...
public class AddConstructionSite extends BaseActivity {
    ...
    private void addSite() {
        ...
        int siteID = viewModel.createConstructionSite(conSite, new OnAsyncEventListener() {
            @Override
            public void onSuccess() {
                System.out.println("Successfully inserted site");
            }

            @Override
            public void onFailure(Exception e) {
                System.out.println("Couldn't insert site");
            }
        });

        Intent intent = new Intent(this, ViewConstructionSite.class);
        intent.putExtra("siteID", 1);// todo 0 has to be replaced with whatever ID will be generated by the DB/maybe done
